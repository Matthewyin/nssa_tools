...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    firebaseAdminProjectId: process.env.FIREBASE_ADMIN_PROJECT_ID || 'n8n-project-460516',

    // 公共配置（客户端和服务端都可用）
    public: {
      firebaseApiKey: process.env.FIREBASE_API_KEY,
      firebaseAuthDomain: process.env.FIREBASE_AUTH_DOMAIN || 'n8n-project-460516.firebaseapp.com',
      firebaseProjectId: process.env.FIREBASE_PROJECT_ID || 'n8n-project-460516',
      firebaseStorageBucket: process.env.FIREBASE_STORAGE_BUCKET || 'n8n-project-460516.appspot.com',
